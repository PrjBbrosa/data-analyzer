...
into ``mf4_analyzer.ultraview_core.model``. This module immediately re-exports
every moved name so existing ``from mf4_analyzer.ui.ultraview_state import
UltraViewRef`` paths keep working, and remains the owner of layout mutation
semantics, payload legalization, presentation digest, and derived preview
status. It must not import Qt, MainWindow, ChartStack, or analysis compute
modules.
"""
