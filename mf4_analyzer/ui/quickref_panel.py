...
Rounded corners WITHOUT ``WA_TranslucentBackground`` on the panel
...
No native backdrop or outer drop shadow: both can leak past the card corners.
"""
...
# The card fills the transparent shell; no outer shadow gutter.
_CARD_RADIUS = 14
_SHELL_MARGIN = 0
...
class QuickRefPanel(QWidget):
    ...
    def _build(self):
        ...
        # The card fills the transparent shell without an outer shadow.
