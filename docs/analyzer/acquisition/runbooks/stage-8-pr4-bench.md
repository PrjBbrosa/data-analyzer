...
2. Build the folder executable and keep its runtime-smoke JSON.
   ...
   .\dist\TraceLab7.9.9\TraceLab7.9.9.exe --acquisition-runtime-smoke --json docs\analyzer\acquisition\evidence\vector-xcp\packaged-runtime-smoke.json
   ```
   ...
   `TraceLab7.9.9.exe --a2l-probe-child`, return code zero, and the expected
