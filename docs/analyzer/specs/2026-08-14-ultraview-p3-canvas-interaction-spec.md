...
- zoom-to-card：双击卡片 = 动画视口过渡至该卡充满视口（FocusLayer 保留为
  兼容路径至 P3-2 验收后再裁）。
- **2026-08-15 批注（viewport-inspect-fixes）**：双击分层为方案 A——未铺满
  双击仍铺满；已铺满同一张卡再双击打开该 View 的临时查看。退出铺满维持
  适应 / 100% / Esc 栈既有出口。临时查看已打开时再次双击幂等，不叠第二层。
  替换意图环武装时二次双击不抢临时查看。上限 200% 本批不做。
