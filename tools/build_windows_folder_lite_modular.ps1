...
# Default output: dist\TraceLabAnalyzer8.3.2-modular\TraceLabAnalyzer8.3.2-modular.exe
# (override with -Version or -AppName). Does not replace dist\TraceLabAnalyzer8.3.2\.
